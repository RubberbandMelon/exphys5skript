...
\subsection{Schwingungsspektren von Molekülen}
	Schwingungen geben grundlegende Auskunft über die Kopplungen der verschiedenen Atome. \autoref{fig:vl09_abbildung_2} zeigt ein Versuchsaufbau zur Messung der Schwingungsspektren eines Moleküls.\\
...
\subsubsection{Der anharmonische Oszillator}
	...
	\begin{figure}[H]
		...
		\caption{Radialsymmetrisches Potential eines zweiatomigen Moleküls mit Gleichgewichtsabstand $R_\mathrm e$ in blau. 
			...
			Das abstoßende Potential tritt wegen des Pauli-Prinzips auf.
			}
	...
	\end{equation}
	\end{important}
	mit Korrekturtermen nicht-linearer Ordnung und der \quickdef{Anharmonizitätskonstante} $$X_\mathrm e=\frac{\hbar  \omega_{\mathrm{e}}}{ 4 \mathrm{D}_{\mathrm{e}}} \approx \num{0,01}$$ und $\omega_\mathrm e = 2\pi\nu_\mathrm e$.
	\begin{definition}{}
...
\subsubsection{Rotations- Schwingungsspektren zweiatomiger Moleküle}
	...
	\end{equation} 
	Die Auswahlregeln sind $ \Delta \nu = \pm 1$, $ \Delta J = \pm 1$. Ebenfalls erlaubt sind reine Rotationsübergänge $ \Delta \nu = 0$, $ \Delta J = \pm 1$. Verboten hingegen ist ein Rotationsübergang mit $ \Delta J =0$. Anschaulich entspräche ein solcher Übergang der plötzlichen Änderung der Bindungslänge und somit einer Änderung des Drehimpulses.\\
