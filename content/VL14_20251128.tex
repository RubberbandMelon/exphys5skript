...
Diese befinden sich im festen Aggregatzustands, welcher zunächst genauer definiert und beschrieben wird.
Festkörper werden als Vielteilchen-Systeme mit $\sim\SI{3e23}{Teilchen}$ beschrieben.
...
Experimentell zeigt sich, dass es die idealisierten Systeme in der Realität nicht exisitieren:
\begin{itemize}
...
Feste Stoffe lassen sich weiter aufteilen in kristlline und amorphe Festkörper:
\begin{itemize}
	\item kristalline Festkörper sind periodische Anordnungen kleiner 'Bauklötze'
	\item amorphe Festkörper besitzen eine feste, nicht periodische, dafür aber statistisch isotrope Anordnung. Es herrschen bestimmte lokale Ordnungen. 
\end{itemize}
...
Die elektrostatische Interaktion zwischen Elektronen und Atomkernen ist fundamental für die Kohäsion von Festkörpern. 
Die Bindung wird je nach Situation anders benannt, es existieren:
\begin{itemize}
...
\paragraph{Elektronegativität}
Die Ionisierungsenergie $I$ gibt an, wie viel Energie nötig ist um ein Elektron von einem Atom zu entfernen:
$$
...
$$ 
Die Elektronegativitätsdifferenz zwischen zwei Elementen gibt Aufschluss über die Charakteristik einer Bindung.
...
$$ 
wobei sich die Parameter $B$ und $n$ entweder aus quantenmachanischen Berechnungen oder experimentellen Befunden, wie den Ergebnissen von Kompressibilitätstests, ergeben. 
...
$$
\frac{\mathrm{d} W_{B}}{\mathrm{d} r}  \Big|_{r=r_{\mathrm{e}}} = N \frac{\mathrm{d}W_{W,i}}{\mathrm{d} r}  \Big|_{r= r_{\mathrm{e}}} = 0.
$$
Es folgt
\stepcounter{equation}
\begin{equation}
...
Die Bindungsenergie kovalenter Bindungen beträgt \SI{6}{\electronvolt} bis \SI{10}{\electronvolt}.
Die Bindungen sind also sehr stark.

Da Stoffe mit kovalenten Bindungen sind Halbleiter, besitzen also nur ein moderate Leitfähigkeit.

Die Unterscheidung zwischen kovalenter und ionischer Bindung ist nicht binär, da die Elektronegativitätdifferenz zwischen verschiedenen Atomen kontinuierlich ist. 
