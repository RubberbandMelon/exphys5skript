...
\subsubsection{Mikrowellen-MASER}
	...
	\begin{figure}
		...
		\end{tikzpicture}
		\caption{Im Mikrowellen-Resonator kommen nur antisymmetrische Teilchen $\varphi_\mathrm a$ an (Inversion). Dort fallen sie in den symmetrischen Zustand $\varphi_\mathrm s$ und emittieren dabei Mikrowellen-Strahlung. Es entsteht stimulierte Inversion.}
		\label{fig:vl10_emission}
	\end{figure}

	Der \ce{NH3}-Maser ist somit ein Zwei-Niveau-Maser. 
	Die Energiebreite ist $\frac{\Delta\nu}{\nu}=\SI{10e-e10}{}$, also hat der Maser ein sehr schmales Frequenzspektrum.