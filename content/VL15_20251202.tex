...
\subsubsection{Die metallische Bindung}
	...
	\begin{itemize}
		\item Die quasi-freien Elektronen einer Metallverbindungen kompensieren die Coulomb-Abstoßung der Metallionen.
...
\subsubsection{Edelgase und Molekülkristalle, Van-der-Waals-Bindungen}
	...
	$\gamma$ und $\sigma$ sind empirische Konstanten. Diese Wechselwirkung durch das Lennard-Jones-Potential ist auch bekannt als \quickdef{Van-der-Waals-Wechselwirkung}.
...
\paragraph{Symmetrien im Gitter}
	...
	\end{itemize}
	\begin{verbal}
		Eine Rotation um $C_5={2\pi/}{5}$ ist nicht möglich. Das ist vergleichbar damit, dass sich eine Sammlung an Fünfecken nicht lückenlos aneinanderlegen lässt.
	\end{verbal}
...
\paragraph{Grundlegende Gitter-Typen}
	...
	\begin{figure}[H]
		...
		\caption{Gitterarten in drei Dimensionen.}
