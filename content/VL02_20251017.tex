...
\subsection{Dielektrische Polarisierbarkeit}
    ...
    \begin{minipage}{0.4\linewidth}
        \begin{important}
            \begin{equation}
                \textbf{Polarisation:}~{\vec p= q\vec d}
            \end{equation}
...
\paragraph{Polarisierbarkeit $\bm\alpha$}
    ...
    \begin{important}
        \begin{equation}
        	...
        	\vec{p}\,_\mathrm{ind} = \alpha \vec{E}_\mathrm{lok}
        \end{equation}
    \end{important}
...
\paragraph{Clausius-Mossotti-Gleichung}
    ...
    \begin{important}
        ...
        \begin{equation}
            { \frac{ \varepsilon -1}{ \varepsilon +2} \frac{M}{ \rho} = \frac{1}{3} \frac{\text{N}_{\text{A}}}{ \varepsilon_0} \alpha \equiv P_{\text{mol}}}
...
\paragraph{Lorentz-Lorenz-Gleichung}
    ...
    \begin{important}
        ...
        \begin{equation}
            {\frac{n^2 -1}{n^2 +2} \frac{M}{ \rho} = \frac{\text{N}_{\text{A}}}{3 \varepsilon_0} \beta \equiv R_{\text{M}}}
        \end{equation}
    \end{important}
...
\paragraph{Orientierungspolarisation}
    ...
    $$
    \vec{P}_{\text{or}} = \frac{ \sum \vec{P}_{\text{p}}}{ V} = N \vec{P}_\text{p}'.
    $$ 
    ...
    \begin{important}
        ...
        \begin{equation}
        	{\vec{P}_{\text{or}}= N \frac{P_\text{p}^2 \vec{E}}{3 \mathrm{k}_{\text{B}}T}}
        	\label{eq:2.16}
        \end{equation}
...
\paragraph{Bemerkungen}
    \begin{itemize}
    	...
    	\item Die genaue Rechnung betrachtet die mittlere Polarisation
            ...
            \begin{verbal_sidebyside}[7cm]
                ...
                Langevin-Funktion für $x\ll$ eine gute Näherung.\\
    ...
    \item Im Festkörper $\left( E _{\text{lok}} = E \right) $ gilt die 
        \begin{important}
            ...
            \begin{equation}
    			\label{2.18}
    			{\frac{ \varepsilon -1}{ \varepsilon +2} \frac{M}{ \rho} = \frac{1}{3 \varepsilon_0} \mathrm{N}_{\mathrm{A}} \left( \alpha + \frac{P_{p}^2 }{3 \mathrm{k}_{\mathrm{B}}T} \right) = P_{M}}
    		\end{equation}
        \end{important}
