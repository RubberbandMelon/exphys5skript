...
\subsection{Reziproke Gitter}
	In einem periodischen Kristall sind alle relevanten Eigenschaften wie Potentiale, Elektronenkonzentrationen etc. ebenfalls periodisch. Es liegt also in unserem Interesse, diese sorgfälltig zu beschreiben und anzuwenden.\\
...
\paragraph{Streuung im reziproken Gitter}
	...
	\begin{figure}[H]
		...
		\caption{Ewald-Kugel und Beugung eines einfallenden Strahles im reziproken Gitter. \cite{Ibach}.\\
			...
			$\vec k$ ist der Wellenvektor des ausfallenden (gebeugten) Strahls, da die Wellenvektoren der Maximabedingung \eqref{eq:II.3.32} genügen.
		}
...
\paragraph{Strukturfaktor}
	...
	\autoref{fig:vl17_diffraktogramm} zeigt, wie sich das Reflektionsverhalten von Festkörpern mit gleicher Gitterform unterscheiden kann.
