...
\subsection{Grundlegende Ideen zur Strukturanalyse}
	...
	Stattdessen erfolgt die Strukturanalyse von Feststoffen durch Beschuss mit hochenergetischen Teilchen und der Untersuchung derer Streuung. 
	...
	und der Neutronen
	$$
	\lambda_{\mathrm{Neutronen}} = \frac{\num{0,028}}{\sqrt{E_{\mathrm{N}}} }
	$$ 
	mit den Wellenlängen in \unit{\nano \meter} und der Energie in \unit{\electronvolt}. 
...
\paragraph{Richtung abgebeugter Wellen}
	...
	In \autoref{fig:vl16_abbildung_2} werden geometrische Vorüberlegung zur Streuung dargestellt.

	\begin{figure}[H]
		\centering
		\incfig{vl16_abbildung_2}
		\caption{Geometrische Vorüberlegungen zur Streuung elektromagnetischer Strahlung an zwei Streuzentren. }
...
\paragraph{Lane Gleichungen}
	...
	\begin{minipage}{0.3\linewidth}
		...
		\begin{tikzpicture}
			...
			\draw[very thick, color = red, ->] (2,0.1) -- (1.3,1) node[pos = 0.4, anchor = south west] {$\Delta\vec k = \vec k - \vec k'$};
		\end{tikzpicture}
		\captionof{figure}{}
...
\paragraph{Bragg'sche Bedingung} 
	...
	In \autoref{fig:vl16_abbildung_4} werden geometrische Vorüberlegung zur Aufstellung der Bragg'schen Bedingung getroffen.
