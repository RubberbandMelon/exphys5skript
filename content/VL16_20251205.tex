\section[Reziprokes Gitter und Kristallstrukturanalyse]{Das Reziproke Gitter und die Kristallstrukturanalyse}
...
\subsection{Beugung am Kristallgitter, Laue- und Bragg-Gleichungen}
...
\paragraph{Laue Gleichungen}
	Die Maxima des elektrischen Feldes treten auf, wenn alle drei Phasenwinkel ganzzahlige Vielfache von $2\pi$ sind.
	Diese Stellen können mithilfe der Laue Gleichungen berechnet werden.
	\begin{important}
		\textbf{Laue Gleichungen}
		\begin{equation}
			\label{eq:II.3.19}
			\begin{split}
		...
		\end{equation} 
	\end{important}
	Die Laue-Indizes $h,k,l$ kennzeichnen die Ordnung des Beugungsmaximums.\\
	
	\begin{minipage}{0.6\linewidth}
		Die Laue Gleichungen beschreiben eine Quantisierung des Anteils des Streuvektros $\Delta k $ jeweils in Richtung des beteiligten primitiven Gittervektors.
