...
\paragraph{Ergebnis} 
	...
	$$ 
	wobei der Index $m$ für eine Summation der übernächsten Nachbarn steht.
	\begin{verbal}
...
\subsubsection{Photoemissionsspektroskopie}
	...
	\begin{figure}[H]
		...
		\caption{Energieschema. 
			...
			Dazu überwindet das Elektron die Energie $E_\mathrm B$ von $E_\mathrm i$ zur Fermienergie $E_\mathrm F$, die Austrittsenergie $\varphi_A$, und die kinetische Energie $E_\mathrm{kin}$ nach dem Austritt.
			Durch Messung der kinetischen Energie können Rückschlüsse auf die Bandenstruktur und die Austrittsarbeit gemacht werden.
			}
...
\paragraph{Lichtquellen}
	...
	Zur Bestimmung der Bandstruktur verwenden wir
	\begin{equation}
		\label{eq:II.8.14}
...
\paragraph{Synchrotron-Strahlungsquellen (UV, XUV, Rö)}\,\\ 
	\begin{figure}[H]
		...
		\caption{Schematischer Aufbau eines Synchrotrons. 
			...
			Bei hohen Geschwindigkeiten bildet das elektrische Feld des Elektrons eine Keule mit Öffnungswinkel $\theta$.
		}
